...
typedef struct
{
    ...
    ALIGNED ae_int64_t     last_action; /**< TODO: describe */
    ALIGNED char *ptr; /**< TODO: describe */
/**
 * @brief
 *
 */
...
typedef struct
{
    ...
    ALIGNED ae_int64_t     datatype; /**< TODO: describe */
    ALIGNED ae_int64_t     owner; /**< TODO: describe */
    ALIGNED ae_int64_t     last_action; /**< TODO: describe */
    ALIGNED void *ptr; /**< TODO: describe */
/**
 * @brief
 *
 */
...
typedef struct
{
    ...
    ALIGNED ae_int64_t     cols; /**< TODO: describe */
    ALIGNED ae_int64_t     stride; /**< TODO: describe */
    ALIGNED ae_int64_t     datatype; /**< TODO: describe */
    ALIGNED ae_int64_t     owner; /**< TODO: describe */
    ALIGNED ae_int64_t     last_action; /**< TODO: describe */
    ALIGNED void *ptr; /**< TODO: describe */
...
typedef struct
{
    ae_int_t mode; /**< TODO: describe */
    ae_int_t entries_needed; /**< TODO: describe */
    ae_int_t entries_saved; /**< TODO: describe */
    ae_int_t bytes_asked; /**< TODO: describe */
    ae_int_t bytes_written; /**< TODO: describe */

#ifdef AE_USE_CPP_SERIALIZATION
    std::string     *out_cppstr; /**< TODO: describe */
#endif
...
typedef struct ae_vector
{
    ...
    {
        void *p_ptr;
        ae_bool *p_bool; /**< TODO: describe */
        ae_int_t *p_int; /**< TODO: describe */
        double *p_double; /**< TODO: describe */
        ae_complex *p_complex; /**< TODO: describe */
    } ptr; /**< TODO: describe */
/**
 * @brief
 *
...
{
    ae_int_t rows; /**< TODO: describe */
    ae_int_t cols; /**< TODO: describe */
    ae_int_t stride; /**< TODO: describe */
    ae_datatype datatype; /**< TODO: describe */
    ...
    union
    {
        void *p_ptr; /**< TODO: describe */
        void **pp_void; /**< TODO: describe */
        ae_bool **pp_bool; /**< TODO: describe */
        ae_int_t **pp_int; /**< TODO: describe */
        double **pp_double; /**< TODO: describe */
        ae_complex **pp_complex; /**< TODO: describe */
    } ptr; /**< TODO: describe */
/**
 * @brief
 *
...
{
    void * volatile obj;
    void * volatile next_entry; /**< TODO: describe */
/**
 * @brief
 *
 */
...
{
    int stage;
    ae_vector ia; /**< TODO: describe */
    ae_vector ba; /**< TODO: describe */
    ae_vector ra; /**< TODO: describe */
    ae_vector ca; /**< TODO: describe */
/**
 * @brief
 *
 */
...
public:
     ...
     * @brief
     *
     * @return alglib_impl::ae_complex
     */
    alglib_impl::ae_complex*       c_ptr();
    /**
     * @brief
     *
     * @return const alglib_impl::ae_complex
     */
 ...
 * @param lhs
 * @param rhs
 * @return const alglib::complex operator
 */
...
extern const xparams &xdefault; /**< TODO: describe */
extern const xparams &serial; /**< TODO: describe */
extern const xparams &parallel; /**< TODO: describe */
...
public:
     ...
     * @brief
     *
     * @return const alglib_impl::ae_vector
     */
    const alglib_impl::ae_vector* c_ptr() const;
    /**
     * @brief
     *
     * @return alglib_impl::ae_vector
     */
...
private:
     ...
     *
     * @param rhs
     * @return const ae_vector_wrapper &operator
     */
...
protected:
     ...
     *
     * @param rhs
     * @return const ae_vector_wrapper
     */
    ...
    //
    alglib_impl::ae_vector *ptr; /**< TODO: describe */
    
    //
    // Inner ae_vector record.
    // Ignored for ptr!=&inner_rec.
    //
    alglib_impl::ae_vector inner_vec; /**< TODO: describe */
    ...
    //
    bool                   is_frozen_proxy; /**< TODO: describe */
};
...
public:
     ...
     *
     * @param rhs
     * @return const boolean_1d_array &operator
     */
...
public:
     ...
     *
     * @param rhs
     * @return const integer_1d_array &operator
     */
     ...
     *
     * @param i
     * @return const ae_int_t &operator
     */
...
public:
     ...
     *
     * @param rhs
     * @return const real_1d_array &operator
     */
...
public:
     ...
     *
     * @param rhs
     * @return const complex_1d_array &operator
     */
     ...
     *
     * @param i
     * @return alglib::complex &operator
     */
...
public:
     ...
     * @brief
     *
     * @return const alglib_impl::ae_matrix
     */
    const alglib_impl::ae_matrix* c_ptr() const;
    /**
     * @brief
     *
     * @return alglib_impl::ae_matrix
     */
...
private:
     ...
     *
     * @param rhs
     * @return const ae_matrix_wrapper &operator
     */
...
protected:
     ...
     *
     * @param rhs
     * @return const ae_matrix_wrapper
     */
    ...
    //
    alglib_impl::ae_matrix *ptr; /**< TODO: describe */
    
    //
    // Inner ae_matrix record.
    // Ignored for ptr!=&inner_mat.
    //
    alglib_impl::ae_matrix inner_mat; /**< TODO: describe */
...
public:
     ...
     *
     * @param rhs
     * @return const boolean_2d_array &operator
     */
...
public:
     ...
     *
     * @param rhs
     * @return const integer_2d_array &operator
     */
...
public:
     ...
     *
     * @param rhs
     * @return const real_2d_array &operator
     */
...
public:
     ...
     *
     * @param rhs
     * @return const complex_2d_array &operator
     */
...
extern const double fp_nan; /**< TODO: describe */
extern const double fp_posinf; /**< TODO: describe */
extern const double fp_neginf; /**< TODO: describe */
extern const ae_int_t endianness; /**< TODO: describe */
static const int CSV_DEFAULT = 0x0; /**< TODO: describe */
static const int CSV_SKIP_HEADERS = 0x1; /**< TODO: describe */
