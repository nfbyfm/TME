...
#include <Control/MathEngine/presolver.h>
...
private:
    ...
    /**
     * @brief Parser for the tokenized formulas of the lexer
     *
     */
    Parser *mParser;

    /**
     * @brief simplifies, presolves and prepares formulas for the solver
     *
     */
    PreSolver *mPreSolver;
