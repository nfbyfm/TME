...
public:
    ...
    /**
     * @brief function for adding another token to list
     *
     */
    void appendTokenList(MToken * newElement);

    /**
     * @brief setter-function for the Value of a specific token
     *
     */
    void setTokenValue(int index, QString newValue);

    /**
     * @brief function for removing Last Token in list
     *
     */
